module "appgw" {
  ...
  aks_agic_identity_client_id = azurerm_user_assigned_identity.agic_user_assigned_identity.client_id
  aks_agic_identity_principal_id = azurerm_user_assigned_identity.agic_user_assigned_identity.principal_id
