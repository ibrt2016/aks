...
variable "workload_identity_enabled" {
  description = "Whether to enable Workload Identity or not. If true, the oidc_issuer_enabled needs to be set to true"
  type        = bool
  default     = false
}
...
variable "windows_profile" {
  description = "Username and password for accessing AKS Windows nodes."
  type = object({
    username = string,
    password = string
  })
...
##########################
variable "agic_identity_custom_name" {
  description = "Name for workload user managed identity"
  type = string
  default = "agic-umid"
