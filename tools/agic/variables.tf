...
# variable "aks_agic_identity_id" {
#   description = "AGIC Identity id used by AKS."
#   type        = string
# }

variable "aks_agic_identity_client_id" {
  description = "AGIC Identity client_id used by AKS."
  type        = string
}

variable "aks_agic_identity_principal_id" {
  description = "AGIC Identity principal_id used by AKS."
  type        = string
}
